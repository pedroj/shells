...
ui <- fluidPage(
	...
	sidebarLayout(
		sidebarPanel(
			column(3,
				   textInput("n_s",
				   			 "n_s: N. points relative to s:",
				   			 value = 350)
			),
			column(3,
				   numericInput("n_t",
				   			 "n_t: N. points relative to theta:",
				   			 value = 1000)
			),
			column(3,
				   numericInput("n",
			...
			column(3,
				   numericInput("s_min",
				   			"s_min: Angle aperture-generating 
				   			curve start (deg):",
				   			min = -300,
				   			max = 300,
				   			value = -180),
			...
			column(3,
				   numericInput("s_max",
				   			"s_max: Angle aperture-generating 
				   			curve ends (deg):",
				   			min = 1,
				   			max = 100,
				   			value = 2),
			...
			column(3,
				   numericInput("A",
				   			 "A: Distance main origin-local 
				   			 origin aperture at theta=0:",
				   			 min = 1,
				   			 max = 500,
				   			 value = 7),
			),
			...
			column(3,
				   numericInput("theta_end",
				   			 "theta_end: 
				   			 trivial for self-similar shells, 
